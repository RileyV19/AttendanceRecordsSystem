...
#+------------------------------------------------
#|  Main App class with GUI
#|    - Manipulate and enter data with a Graphic
#|      User Interface with buttons and text
#|      fields
#+------------------------------------------------
class App(tkinter.Frame):
    ...
    #+---------------------------------------
    #|  GUI Functions - Enter and Query data with a form-like experience
    #+---------------------------------------

    # Clear GUI widgets from background
    ...
    # Background submission function - Score Students
    ...
    # Background search function - Student details
    ...
    #+---------------------------------------
    #|  Command-line User Interface - create and manipulate data from command line
    #+---------------------------------------
